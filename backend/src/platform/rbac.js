...
const MATRIX = {
  ...
  COMMANDER: [
    ...
    P.UPDATE_OWN_UNIT, P.ANALYTICS, P.SEE_REPORTER_CONTACT, P.RUN_SIMULATION,
  ],
  DISPATCHER: [
    P.VIEW_INCIDENTS, P.EDIT_INCIDENT, P.APPROVE_DISPATCH, P.MERGE_INCIDENT,
    P.SUPERSEDE_EVIDENCE, P.UPDATE_OWN_UNIT, P.ANALYTICS, P.SEE_REPORTER_CONTACT, P.RUN_SIMULATION,
  ],
