            ...
            <div className="w-full h-full flex flex-col md:flex-row overflow-hidden">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-3">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <select
                          ...
                          className={`w-full h-10 pl-3.5 pr-10 bg-slate-50 border rounded-xl text-sm font-semibold text-slate-900 focus:bg-white focus:border-blue-600 focus:ring-1 focus:ring-blue-600 focus:outline-none appearance-none transition-colors cursor-pointer ${
                            autofilledField ? 'border-blue-500 bg-blue-50/30' : 'border-slate-200'
                          }`}
                        >
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        className={`w-full p-3 bg-slate-50 border rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-blue-600 focus:ring-1 focus:ring-blue-600 focus:outline-none transition-colors resize-none font-sans leading-relaxed ${
                          autofilledField ? 'border-blue-500 bg-blue-50/30' : 'border-slate-200'
                        }`}
                        required
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full h-10 px-3.5 bg-slate-50 border rounded-xl text-sm text-slate-900 placeholder:text-slate-400 focus:bg-white focus:border-blue-600 focus:ring-1 focus:ring-blue-600 focus:outline-none transition-colors ${
                          autofilledField ? 'border-blue-500 bg-blue-50/30' : 'border-slate-200'
                        }`}
                      />
                    </div>
              ...
              <div className="w-full md:w-1/2 h-full p-6 sm:p-9 flex flex-col justify-between bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-between pb-4 border-b border-slate-800">
                  ...
                  <div className={`px-3.5 py-1 rounded-full text-xs sm:text-sm font-bold flex items-center gap-2 border ${
                    isRecording
